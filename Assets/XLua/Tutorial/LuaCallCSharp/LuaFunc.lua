function demo()
            ...
            local testobj = DerivedClass() --new一个DerivedClass()对象
            testobj.DMF = 1024--设置成员属性
            print(testobj.DMF)--读取成员属性
            testobj:DMFunc()--成员方法，记得用：

            --基类属性，方法
            print(DerivedClass.BSF)--读基类静态属性，静态属性用类名调用
            DerivedClass.BSF = 2048--写基类静态属性
            DerivedClass.BSFunc();--基类静态方法，调用静态方法
            print(testobj.BMF)--读基类成员属性
            testobj.BMF = 4096--写基类成员属性
            testobj:BMFunc()--基类方法调用，记得用：
