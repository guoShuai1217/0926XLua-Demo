...
{
    public class MyCSharpCallLuaIGetDBridge : LuaBase, MyCSharpCallLua.IGetD
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new MyCSharpCallLuaIGetDBridge(reference, luaenv);
		}
		
		public MyCSharpCallLuaIGetDBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
