...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(guoShuai.Lua.LuaViewBehaviour), guoShuaiLuaLuaViewBehaviourWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(guoShuai.Lua.LuaHelper), guoShuaiLuaLuaHelperWrap.__Register);
        ...
        static void Init(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.AddInterfaceBridgeCreator(typeof(MyCSharpCallLua.IGetD), MyCSharpCallLuaIGetDBridge.__Create);
