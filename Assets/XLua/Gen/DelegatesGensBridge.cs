...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp0(int p0, int p1, out int p2)
		{
		...
		public XLuaTest.InvokeLua.ICalc __Gen_Delegate_Imp4(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(MyCSharpCallLua.GetF))
			{
			    return new MyCSharpCallLua.GetF(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(MyCSharpCallLua.GetE))
			{
			    return new MyCSharpCallLua.GetE(__Gen_Delegate_Imp1);
			}
		    ...
		    if (type == typeof(guoShuai.Lua.LuaViewBehaviour.delLuaAwake))
			{
			    return new guoShuai.Lua.LuaViewBehaviour.delLuaAwake(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(guoShuai.Lua.LuaViewBehaviour.delLuaStart))
			{
			    return new guoShuai.Lua.LuaViewBehaviour.delLuaStart(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(guoShuai.Lua.LuaViewBehaviour.delLuaUpdate))
			{
			    return new guoShuai.Lua.LuaViewBehaviour.delLuaUpdate(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(guoShuai.Lua.LuaViewBehaviour.delLuaOnDestroy))
			{
			    return new guoShuai.Lua.LuaViewBehaviour.delLuaOnDestroy(__Gen_Delegate_Imp3);
			}
			...
			{
			    return new XLuaTest.InvokeLua.CalcNew(__Gen_Delegate_Imp4);
			}
